...
if(isset($_POST['addCourse'])) {
    ...
    $sql = "INSERT INTO course (name, course_id, fees) VALUES ('$cname', '$cid', '$cfees')";
...
<body>
    ...
    <aside>
        <ul>
            ...
            <li>
                <a href="add_courses.php" class="active">Add Courses</a>
            </li>
        </ul>
    </aside>
        ...
        <?php 
            if($showAlert) {
                echo '<div class="alert alert-success alert-dismissible fade show mb-0" role="alert">
                    <strong>Success!</strong> Course added in the database.
        ...
        <div class="form" style="width:100%; padding:20px">
          <form action="#" method="POST">
            <div class="modal-body">
              ...
              <div class="form-floating mb-3">
                <input type="text" class="form-control" id="floatingInput" placeholder="ID" name="course_id">
                <label for="floatingInput">Course ID</label>
              </div>
              <div class="form-floating mb-3">
                <input type="text" class="form-control" id="floatingInput" placeholder="Course Fees" name="fees">
                <label for="floatingInput">Course Fees (in ₹)</label>
              </div>
              <!-- <div class="form-floating mb-3">
            ...
            <div class="modal-footer">
              <input class="btn btn-dark" type="Submit" value="Add Course" name="addCourse" style="width:100%">
            </div>
          </form>
        </div>
    </div>
